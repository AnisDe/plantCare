...
class CommentairesView: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if commentaires[indexPath.row].User?._id == UserDefaults.standard.string(forKey: "idUtilisateur") {
       ...
       // }
        ...
        labelUsername.text = (commentaire.User?.name)!
        labelCommentaire.text = commentaire.description
    ...
    func recupererCommentaires() {
        ...
        CommentaireViewModel().recupererCommentaireParPublication(idPublication: (plant?._id)!) { (success, com) in
            if success {
    ...
    @IBAction func envoyerCommentaire(_ sender: Any) {
        ...
        CommentaireViewModel().ajouterCommentaire(idPublication: (plant?._id)!, commentaire: Commentaire(description: nouveauCommentaireTextField.text, date: Date())) { success in
            if success {
