...
req.body.password
  ...
  async function sendConfirmationEmail(Email, token) {
    ...
    const mailOptions = {
        from: 'PLANT-CARE<testrapide45@gmail.com>',
      to: Email,
      text: 'For clients with plaintext support only',
      subject: 'PlantCare ACCOUNT ',
...
async function envoyerEmailReinitialisation(email, token, codeDeReinit) {
  ...
  const mailOptions = {
    from: 'PLANT-Care<testrapide45@gmail.com>',
    to: email,
    subject: 'Reinitialisation de votre mot de passe - PLANT-Care',
...
module.exports ={
register, login,reEnvoyerConfirmationEmail,confirmation,motDePasseOublie,changerMotDePasse,getByToken
}
